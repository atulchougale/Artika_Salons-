...
<head>
    ...
    <title>Artika Saloon | Payment</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container booking-container">
        ...
        <h2> Your Selected Details For Booking An Appoinment </h2>
        ...
        $query = "SELECT sa.bookid, sa.date, sa.time, r.fname, b.barbername, s.subServiceStylePrice, s.subServiceStyleTitle
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo '<thead><tr><th>Book ID</th><th>Date</th><th>Time</th><th>User Name</th><th>Barber Name</th><th>Service Name</th><th>Service Price</th></tr></thead>';
            echo '<tbody>';
        ...
        <div class="container mt-5" id="cardFormContainer" style="display: none;">
            ...
            <form id="cardPaymentForm" action="#" method="post" onsubmit="return validateCardForm()">
                ...
                <div class="text-center mt-3">
                    <button type="submit" value="Submit" name="paymentMethod" class="btn btn-primary btn-lg px-5 py-2">Book Appointment</button>
                </div>
            </form>
        </div>
        ...
        function validateBankTransferForm() {
            ...
            swal({
                ...
                if (value) {
                    ...
                    link.href = 'invoice.php?bookid=<?php echo $bookid; ?>';
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['paymentMethod'])) {
    ...
    $status = '1';
    $query = "UPDATE `serviceapointment` SET `status` = '$status', `paymentid` = '$dummyPaymentId' WHERE `bookid` ='$bookid'";
    $result = mysqli_query($conn, $query);
    ...
    if ($result) {
        echo "<script>
            swal({
                ...
                if (value) {
                    ...
                    window.location.href = 'invoice.php?bookid=$bookid';
                }
            });
        </script>";
    } else {
        echo "<script>
            swal({
                ...
                window.location.href ='appayment.php?bookid=$bookid';
            });
        </script>";
    }
} else {
